...
directly as `python -m alfaedge_pulse.console_relay.relay`, not through
...
FRAPPE_RESOLVE_URL = os.environ.get(
	"FRAPPE_INTERNAL_URL", "http://127.0.0.1:8000/api/method/alfaedge_pulse.console_relay.api.resolve_session"
)
