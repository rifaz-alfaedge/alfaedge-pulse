...
on sites that had alfaedge_pulse installed *before* v3.0.0 (Host Health)
...
from alfaedge_pulse.install import _seed_default_expected_services, _setup_host_health_agent
