...
from alfaedge_pulse.bifrost_client.base import BifrostAPIError, BifrostClient
...
BIFROST_SYNC_JOB_ID = "alfaedge_pulse_bifrost_sync"
...
def enqueue_sync() -> None:
	...
	frappe.enqueue(
		"alfaedge_pulse.tasks.bifrost_sync.run_sync_now",
		queue="long",
